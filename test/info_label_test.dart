...
void main() {
  ...
  testWidgets('InfoLabel displays correct left icon', (WidgetTester tester) async {
  ...
  testWidgets('InfoLabel displays correct right icon', (WidgetTester tester) async {
  ...
  testWidgets('InfoLabel displays correct type of label', (WidgetTester tester) async {
    ...
    final labelFinder = find.byWidgetPredicate(
          (widget) => widget is InfoLabel && widget.typeInfoLabel.name == expectedType.name,
    );
  ...
  testWidgets('InfoLabel displays correct background color', (WidgetTester tester) async {
    ...
    final containerFinder = find.byWidgetPredicate(
          (widget) => widget is InfoLabel && widget.backgroundColor == expectedBackgroundColor,
    );

    expect(containerFinder, findsOneWidget);
  });

  testWidgets('InfoLabel displays correct text color', (WidgetTester tester) async {
