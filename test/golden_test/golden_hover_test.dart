...
void main() {
  runGoldenTest(
    [
      scenario(
        'base_info_normal',
        const InfoLabel(text: 'Normal', typeInfoLabel: TypeInfoLabel.info),
      ),
      scenario(
        'base_info_hover_simulated',
        InfoLabel(
          text: 'Hover',
      ...
      scenario(
        'custom_hover_normal',
        const InfoLabel(text: 'Normal', typeInfoLabel: TypeInfoLabel.success),
      ),
      scenario(
        'custom_hover_simulated',
        InfoLabel(
          text: 'Hover',
      ...
      scenario(
        'globalColor_normal',
        const InfoLabel(text: 'Normal', globalColor: Colors.purple),
      ),
      scenario(
        'globalColor_hover_simulated',
        InfoLabel(
          text: 'Hover',
          globalColor: Colors.purple,
          backgroundColor: Colors.purple.withValues(alpha: 0.3),
        ),
      ),
      scenario(
        'error_normal',
        const InfoLabel(text: 'Normal', typeInfoLabel: TypeInfoLabel.error),
      ),
      scenario(
        'error_hover_simulated',
        InfoLabel(
          text: 'Hover',
