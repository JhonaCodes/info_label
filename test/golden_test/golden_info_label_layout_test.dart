...
final List<Widget> layoutTestScenarios = [
  ...
  GoldenTestScenario(
    ...
    child: const InfoLabel(
      ...
      leftIcon: Icon(Icons.warning_amber_rounded, color: Colors.amber),
...
void main() => runGoldenTest(
      layoutTestScenarios,
      groupData: "INFO_LABEL_ICONS_AND_LAYOUTS_TESTS",
      goldenName: 'Icons and Complex Layouts Variations',
